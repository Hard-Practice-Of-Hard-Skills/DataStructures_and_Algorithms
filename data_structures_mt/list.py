...
class ArrayList:
    ...
    def add_front(self, item):
        ...
        try:
            ...
            raise TypeError('ArrayList: Add to front type error')
    ...
    def insert(self, item, index):
        ...
        try:
            ...
            raise TypeError('ArrayList: Insertion type error')
    ...
    def add_back(self, item):
        ...
        try:
            ...
            raise TypeError('ArrayList: Add to back type error')
    ...
    def pop(self, pos=-1):
        ...
        try:
            ...
            raise TypeError('ArrayList: pop index error')
